...
//		dsc.setUrl("jdbc:mysql://192.168.5.153:3306/qwd_test");
		dsc.setUsername("root");
		dsc.setPassword("896757055");
//		dsc.setUsername("qwd_pdloan_test");
//		dsc.setPassword("qwd_pdloan_test@2018");
//		dsc.setUrl("jdbc:mysql://rm-bp1qjh9l4r2u752263o.mysql.rds.aliyuncs.com:3306/qwd_pdloan_test");
		...
		strategy.setInclude(new String[] { "ct_adm_menu_node", "", "" }); // 需要生成的表
